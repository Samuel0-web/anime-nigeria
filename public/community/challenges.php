...
$pageTitle = "Anime Challenges | Anime Nigeria";
$pageDescription = "Showcase your creativity through anime-inspired drawing, cosplay, voice acting, and other community challenges.";
    ...
    <section class="an-challenges-hero">
        ...
        <div class="an-container">
            <div class="an-challenges-hero__inner an-reveal">
                ...
                <p class="an-challenges-hero__description">
                    Anime Nigeria Challenges bring fans together through seasonal
                    creative competitions. Whether you're an artist, cosplayer,
                    editor, writer or photographer, every challenge is an opportunity
                    to learn, showcase your talent and inspire the community.
                </p>
        ...
        <div class="an-container">
            <div class="an-section-heading an-reveal">
                ...
                <p>
                    ...
                    designed to be fair, fun and community-driven.
                </p>
            </div>
    ...
    <section class="an-challenge-types">
        <div class="an-container">
            <div class="an-section-heading an-reveal">
                ...
                <p>
                    Throughout the year, Anime Nigeria hosts different community
                    challenges that celebrate creativity, passion and talent across
                    multiple interests.
                </p>
            </div>
            ...
            <div class="an-challenge-types__grid">
                <article class="an-challenge-type an-reveal">
                    ...
                    <p>
                        Create original anime-inspired artwork and share your
                ...
                <article class="an-challenge-type an-reveal">
                    ...
                    <p>
                        Showcase your favourite characters through costumes,
                ...
                <article class="an-challenge-type an-reveal">
                    ...
                    <p>
                        Bring iconic anime scenes to life with your own voice
                        acting performance.
                    </p>
                </article>
                ...
                <article class="an-challenge-type an-reveal">
                    ...
                    <p>
                        Capture anime-inspired photography, figures,
                        collections or community moments.
                    </p>
                </article>
                ...
                <article class="an-challenge-type an-reveal">
                    ...
                    <p>
                        Create exciting anime edits, AMVs and cinematic
                        highlights that impress the community.
                    </p>
                </article>
                ...
                <article class="an-challenge-type an-reveal">
                    ...
                    <p>
                        New challenge formats are introduced throughout the year,
    ...
    <section class="an-challenge-highlights">
        <div class="an-container">
            <div class="an-section-heading an-reveal">
                ...
                <p>
                    Future Anime Nigeria Challenges will showcase standout entries
                    and recognize creators whose work inspires the community.
                </p>
            </div>

            <p class="an-challenge-highlights__notice an-reveal">
                Illustrative examples of how future challenge highlights will be displayed.
            </p>
    ...
    <section class="an-challenge-guidelines">
        <div class="an-container">
            <div class="an-section-heading an-reveal">
                ...
                <p>
                    Every Anime Nigeria Challenge is built around creativity,
                    originality and respect for fellow community members. Following
                    these simple guidelines helps keep every event enjoyable and fair.
                </p>
            </div>
            ...
            <div class="an-challenge-guidelines__grid">
                <article class="an-guideline-card an-guideline-card--good an-reveal">
                    ...
                    <ul>
                        ...
                        <li>Follow each challenge's specific theme.</li>
                        <li>Respect fellow participants and judges.</li>
                ...
                <article class="an-guideline-card an-guideline-card--warning an-reveal">
                    ...
                    <ul>
                        <li>Plagiarized or AI-generated work where prohibited.</li>
                        <li>Offensive, hateful or inappropriate content.</li>
                        <li>Harassing or insulting other participants.</li>
            ...
            <p class="an-challenge-guidelines__note an-reveal">
                ...
                Each challenge may include additional rules, judging criteria and
