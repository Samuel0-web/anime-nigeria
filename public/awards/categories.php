            ...
            <div class="an-category-groups__grid">
                <article class="an-category-group an-category-group--gold an-reveal">
                    <header class="an-category-group__header">
                        ...
                        <div>
                            <span class="an-category-group__label">Story Awards</span>
                ...
                <article class="an-category-group an-category-group--sakura an-reveal">
                    <header class="an-category-group__header">
                        ...
                        <div>
                            <span class="an-category-group__label">Visual Awards</span>
                            <h3>Animation & Art</h3>
                        </div>
                    </header>
                ...
                <article class="an-category-group an-category-group--teal an-reveal">
                    <header class="an-category-group__header">
                        ...
                        <div>
                            <span class="an-category-group__label">Music Awards</span>
                            <h3>Sound & Themes</h3>
                        </div>
                    </header>
                ...
                <article class="an-category-group an-category-group--ember an-reveal">
                    <header class="an-category-group__header">
                        ...
                        <div>
                            <span class="an-category-group__label">Discovery Awards</span>
                ...
                <article class="an-category-group an-category-group--crimson an-reveal">
                    <header class="an-category-group__header">
                        ...
                        <div>
                            <span class="an-category-group__label">Genre Awards</span>
                ...
                <article class="an-category-group an-category-group--violet an-reveal">
                    <header class="an-category-group__header">
                        ...
                        <div>
                            <span class="an-category-group__label">Performance Awards</span>
        ...
        <div class="an-container">
            ...
            <div class="an-category-judging__grid">
                <article class="an-category-judging__item an-reveal">
                    ...
                    <h3>Story & Impact</h3>
                    <p>Memorable storytelling, emotional weight and lasting impact.</p>
                </article>
                ...
                <article class="an-category-judging__item an-reveal">
                    ...
                    <p>Character growth, personality and unforgettable moments.</p>
                </article>
                ...
                <article class="an-category-judging__item an-reveal">
                    ...
                    <p>Animation, direction, cinematography and artistic quality.</p>
                </article>
                ...
                <article class="an-category-judging__item an-reveal">
                    ...
                    <p>How strongly the community connected with the nominee.</p>
                </article>
                ...
                <article class="an-category-judging__item an-reveal">
                    ...
                    <h3>Sound & Music</h3>
                    <p>Voice acting, soundtrack and memorable opening or ending themes.</p>
                </article>
                ...
                <article class="an-category-judging__item an-reveal">
                    ...
                    <p>Influence, discussion and the impression left on the anime community.</p>
                </article>
            </div>
        </div>
    </section>
    ...
    <section class="an-category-cta">
        <div class="an-container">
            <div class="an-category-cta__content an-reveal">
                <span class="an-eyebrow">See You At The Awards</span>
                ...
                <div class="an-category-cta__actions">
                    <a href="/awards/nominations" class="an-btn an-btn--primary">
                        Explore Nominations
                    </a>
